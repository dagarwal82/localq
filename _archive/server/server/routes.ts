...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/buying-queue", async (req, res) => {
    try {
      await storage.updateMissedStatuses();
  ...
  app.get("/api/products/:productId/buying-queue", async (req, res) => {
    try {
      await storage.updateMissedStatuses();
  ...
  app.post("/api/buying-queue", joinQueueLimiter, async (req, res) => {
    try {
